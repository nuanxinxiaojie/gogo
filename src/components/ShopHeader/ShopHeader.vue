<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="one=!one">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="two=!two">
    ...
    <div class="shop-brief-modal" v-show="one">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close"  @click="one=!one"></span>
        </div>
      </div>
      <div class="brief-modal-cover"  @click="one=!one"></div>
    </div>
    <div class="activity-sheet" v-show="two">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="two=!two"></span>
        </div>
      </div>
      <div class="activity-sheet-cover" @click="two=!two"></div>
    </div>
  </div>
</template>
